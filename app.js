/*! 
 * Icecream Digital Offical Application
 * Follow us @icecreamdigital
 * URL: http://icecreamdigital.co.uk
 * :)
 */
...
(function(){
  ...
  app.controller('newsController', [ '$http', '$scope', '$rootScope', function($http, $scope, $rootScope){
    ...
    $scope.yourAPI = 'http://www.icecreamdigital.co.uk/api/get_recent_posts/';
    $scope.items = [];
    $scope.totalPages = 0;
    $scope.currentPage = 1;
    $scope.pageNumber = 1;
  ...
  app.controller('pluginsController', function($scope, $compile){
    ...
    $scope.openEmailClient = function(){
      ...
      ons.ready(function(){
        ...
        cordova.plugins.email.open({
          to:      'hello@icecreamdigital.co.uk',
          subject: 'Hey!',
    ...
    $scope.getDirectionsApple = function(){
      ...
      window.location.href = "maps://maps.apple.com/?q=53.4989859,-2.2602142";

    }

    $scope.getDirectionsGoogle = function(){

      var ref = window.open('http://maps.google.com/maps?q=53.4989859,-2.2602142', '_system', 'location=yes');
